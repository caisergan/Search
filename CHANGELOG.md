...
- Bigger tabs, if you want them: Settings › Customization › Tab size › Large. Titles, site icons, rows and pinned squares grow a step, in the sidebar and across the top; Regular is the size they always were. ([#102](https://github.com/driceroland/Search/issues/102))
- The zoom level can show at the top of the page instead of the bottom: Settings › Customization › Show zoom at, with the top left, the top middle or the top right, where most browsers show it. The bottom stays the default, and other messages stay there. ([#103](https://github.com/driceroland/Search/issues/103))
- New tab can live at the foot of the sidebar: Settings › Customization › New tab at the foot of the sidebar puts a + in its bottom right corner, in a place that doesn't move as tabs come and go. Off by default; the row under the last tab stays. ([#104](https://github.com/driceroland/Search/issues/104))
